...
export default function Login() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      // ⚙️ تأكد من الترتيب المطلوب حسب الباك
      const payload = {
  ...
  return (
    <div className="auth-page">
      <div className="auth-container" id="container">
        ...
        <div className="form-container sign-up-container">
          <form onSubmit={handleRegister}>
            ...
            <input
              ...
              onChange={(e) =>
                setRegisterData({ ...registerData, personal_id: Number(e.target.value) })
              }
            />
            ...
            <input
              ...
              onChange={(e) => setRegisterData({ ...registerData, mobile1: e.target.value })}
              required
            />
            ...
            <input
              ...
              onChange={(e) => setRegisterData({ ...registerData, residency: e.target.value })}
              required
            />

            <input
              type="number"
              placeholder="Budget (e.g. 9000)"
              value={registerData.budget}
              onChange={(e) => setRegisterData({ ...registerData, budget: e.target.value })}
              required
            />
        ...
        {/* 🔹 Sign In Form (ما عدلت عليه أبداً) */}
